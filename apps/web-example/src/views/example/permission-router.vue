  ...
  <div class="max-w-full">
    <div class="mb-7">
      ...
      <p class="text-sm text-slate-500 leading-relaxed">
        通过路由 meta 配置
        <code class="border border-blue-100 rounded bg-blue-50 px-1.5 py-0.5 text-xs text-blue-600">requireLogin: true</code>，
        由路由守卫统一拦截未登录访问。
      </p>
    </div>
    ...
    <div class="border border-slate-200 rounded-xl bg-white p-6 shadow-sm">
      ...
      <div class="break-all border border-slate-200 rounded-lg bg-slate-50 px-4 py-3 text-sm">
