import{_ as a,c as i,o as n,a4 as e}from"./chunks/framework.D40SqJrm.js";const o=JSON.parse('{"title":"环境配置","description":"","frontmatter":{},"headers":[],"relativePath":"guide/configure.md","filePath":"guide/configure.md"}'),l={name:"guide/configure.md"};function p(t,s,h,k,d,c){return n(),i("div",null,s[0]||(s[0]=[e(`<h1 id="环境配置" tabindex="-1">环境配置 <a class="header-anchor" href="#环境配置" aria-label="Permalink to &quot;环境配置&quot;">​</a></h1><p>默认提供三套环境配置，分别为：</p><div class="vp-code-group vp-adaptive-theme"><div class="tabs"><input type="radio" name="group-GJu2Z" id="tab-jpGsc6V" checked><label data-title=".env.development 开发环境" for="tab-jpGsc6V">.env.development 开发环境</label><input type="radio" name="group-GJu2Z" id="tab-3cYT4fK"><label data-title=".env.test 测试环境" for="tab-3cYT4fK">.env.test 测试环境</label><input type="radio" name="group-GJu2Z" id="tab-s74GfYl"><label data-title=".env.production 生产环境" for="tab-s74GfYl">.env.production 生产环境</label></div><div class="blocks"><div class="language-yaml vp-adaptive-theme active"><button title="Copy Code" class="copy"></button><span class="lang">yaml</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;"># 页面标题</span></span>
